...
import '../../data/repositories/word_match_repository.dart';
import '../../data/repositories/zip_level_repository.dart';
...
final scoreRepositoryProvider = Provider(
  (ref) => ScoreRepository(ref.watch(sharedPreferencesProvider)),
);
